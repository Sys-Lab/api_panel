...
/*placeholder.js*/function inputPlaceholder(a,b){var c,d,e;return a?a.placeholder&&"placeholder"in document.createElement(a.tagName)?a:(b=b||"#AAA",c=a.style.color,d=a.getAttribute("placeholder"),(""===a.value||a.value==d)&&(a.value=d,a.style.color=b,a.setAttribute("data-placeholder-visible","true")),e="addEventListener",a[e]("focus",function(){a.style.color=c,a.getAttribute("data-placeholder-visible")&&(a.setAttribute("data-placeholder-visible",""),a.value="")},!1),a[e]("blur",function(){""===a.value?(a.setAttribute("data-placeholder-visible","true"),a.value=d,a.style.color=b):(a.style.color=c,a.setAttribute("data-placeholder-visible",""))},!1),a.form&&a.form[e]("submit",function(){a.getAttribute("data-placeholder-visible")&&(a.value="")},!1),a):null}
/*filer.js*/
var FILER_ERROR=function(e){console.error(e)};

"use strict";var self=this;self.URL=self.URL||self.webkitURL;self.requestFileSystem=self.requestFileSystem||self.webkitRequestFileSystem;self.resolveLocalFileSystemURL=self.resolveLocalFileSystemURL||self.webkitResolveLocalFileSystemURL;navigator.temporaryStorage=navigator.temporaryStorage||navigator.webkitTemporaryStorage;navigator.persistentStorage=navigator.persistentStorage||navigator.webkitPersistentStorage;self.BlobBuilder=self.BlobBuilder||self.MozBlobBuilder||self.WebKitBlobBuilder;if(void 0===self.FileError){var FileError=function(){};FileError.prototype.prototype=Error.prototype}var Util={toArray:function(a){return Array.prototype.slice.call(a||[],0)},strToDataURL:function(a,b,c){var d=void 0!=c?c:true;if(d)return"data:"+b+";base64,"+self.btoa(a);else return"data:"+b+","+a},strToObjectURL:function(a,b){var c=new Uint8Array(a.length);for(var d=0;d<c.length;++d)c[d]=a.charCodeAt(d);var e=new Blob([c],b?{type:b}:{});return self.URL.createObjectURL(e)},fileToObjectURL:function(a){return self.URL.createObjectURL(a)},fileToArrayBuffer:function(a,b,c){var d=new FileReader;d.onload=function(a){b(a.target.result)};d.onerror=function(a){if(c)c(a)};d.readAsArrayBuffer(a)},dataURLToBlob:function(a){var b=";base64,";if(a.indexOf(b)==-1){var c=a.split(",");var d=c[0].split(":")[1];var e=c[1];return new Blob([e],{type:d})}var c=a.split(b);var d=c[0].split(":")[1];var e=window.atob(c[1]);var f=e.length;var g=new Uint8Array(f);for(var h=0;h<f;++h)g[h]=e.charCodeAt(h);return new Blob([g],{type:d})},arrayBufferToBlob:function(a,b){var c=new Uint8Array(a);return new Blob([c],b?{type:b}:{})},arrayBufferToBinaryString:function(a,b,c){var d=new FileReader;d.onload=function(a){b(a.target.result)};d.onerror=function(a){if(c)c(a)};var e=new Uint8Array(a);d.readAsBinaryString(new Blob([e]))},arrayToBinaryString:function(a){if(typeof a!=typeof[])return null;var b=a.length;var c=new Array(b);while(b--)c[b]=String.fromCharCode(a[b]);return c.join("")},getFileExtension:function(a){var b=a.lastIndexOf(".");return b!=-1?a.substring(b):""}};var MyFileError=function(a){this.prototype=FileError.prototype;this.code=a.code;this.name=a.name};FileError.BROWSER_NOT_SUPPORTED=1e3;FileError.prototype.__defineGetter__("name",function(){var a=Object.keys(FileError);for(var b=0,c;c=a[b];++b)if(FileError[c]==this.code)return c;return"Unknown Error"});var Filer=new function(){var a="Filesystem has not been initialized.";var b="Not implemented.";var c="Path was not a directory.";var d="These method arguments are not supported.";var e="filesystem:";var f=1024*1024;var g=null;var h=null;var i=false;var j=function(a){return 0==a.indexOf(e)};var k=function(a){if(!j(a))if("/"==a[0])a=g.root.toURL()+a.substring(1);else if(0==a.indexOf("./")||0==a.indexOf("../"))if("../"==a&&h!=g.root)a=h.toURL()+"/"+a;else a=h.toURL()+a;else a=h.toURL()+"/"+a;return a};var l=function(a,b){var c=arguments[1];var d=arguments[2];var e=function(a){if(a.code==FileError.NOT_FOUND_ERR)if(d)FILER_ERROR(0,'"'+c+'" or "'+d+'" does not exist.');else FILER_ERROR(0,'"'+c+'" does not exist.');else FILER_ERROR(0,"Problem getting Entry for one or more paths.")};var f=k(c);if(3==arguments.length){var g=k(d);self.resolveLocalFileSystemURL(f,function(b){self.resolveLocalFileSystemURL(g,function(c){a(b,c)},e)},e)}else self.resolveLocalFileSystemURL(f,a,e)};var m=function(b,c,e,f,h,i){var j=this;if(!g)throw new Error(a);if(typeof b!=typeof c)throw new Error(d);var k=e||null;var m=void 0!=i?i:false;if((b.isFile||c.isDirectory)&&c.isDirectory)if(m)b.moveTo(c,k,f,h);else b.copyTo(c,k,f,h);else l(function(a,b){if(!b.isDirectory){var c=new Error('Oops! "'+b.name+" is not a directory!");if(h)h(c);else throw c;return}if(m)a.moveTo(b,k,f,h);else a.copyTo(b,k,f,h)},b,c)};function n(a){g=a||null;if(g){h=g.root;i=true}}n.DEFAULT_FS_SIZE=f;n.version="0.4.1";n.prototype={get fs(){return g},get isOpen(){return i},get cwd(){return h}};n.prototype.pathToFilesystemURL=function(a){return k(a)};n.prototype.init=function(a,b,c){if(!self.requestFileSystem)throw new MyFileError({code:FileError.BROWSER_NOT_SUPPORTED,name:"BROWSER_NOT_SUPPORTED"});var d=a?a:{};var e=d.size||f;this.type=self.TEMPORARY;if("persistent"in d&&d.persistent)this.type=self.PERSISTENT;var j=function(a){this.size=e;g=a;h=g.root;i=true;b&&b(a)};if(this.type==self.PERSISTENT&&!!navigator.persistentStorage)navigator.persistentStorage.requestQuota(e,function(a){self.requestFileSystem(this.type,a,j.bind(this),c)}.bind(this),c);else self.requestFileSystem(this.type,e,j.bind(this),c)};n.prototype.ls=function(b,c,d){if(!g)throw new Error(a);var e=function(a){h=a;var b=[];var e=h.createReader();var f=function(){e.readEntries(function(a){if(!a.length){b.sort(function(a,b){return a.name<b.name?-1:b.name<a.name?1:0});c(b)}else{b=b.concat(Util.toArray(a));f()}},d)};f()};if(b.isDirectory)e(b);else if(j(b))l(e,k(b));else h.getDirectory(b,{},e,d)};n.prototype.mkdir=function(b,c,d,e){if(!g)throw new Error(a);var f=null!=c?c:false;var i=b.split("/");var j=function(a,c){if("."==c[0]||""==c[0])c=c.slice(1);a.getDirectory(c[0],{create:true,exclusive:f},function(a){if(a.isDirectory){if(c.length&&1!=i.length)j(a,c.slice(1));else if(d)d(a)}else{var f=new Error(b+" is not a directory");if(e)e(f);else throw f}},function(a){if(a.code==FileError.INVALID_MODIFICATION_ERR){a.message="'"+b+"' already exists";if(e)e(a);else throw a}})};j(h,i)};n.prototype.open=function(b,c,d){if(!g)throw new Error(a);if(b.isFile)b.file(c,d);else l(function(a){a.file(c,d)},k(b))};n.prototype.create=function(b,c,d,e){if(!g)throw new Error(a);var f=null!=c?c:true;h.getFile(b,{create:true,exclusive:f},d,function(a){if(a.code==FileError.INVALID_MODIFICATION_ERR)a.message="'"+b+"' already exists";if(e)e(a);else throw a})};n.prototype.mv=function(a,b,c,d,e){m.bind(this,a,b,c,d,e,true)()};n.prototype.rm=function(b,c,d){if(!g)throw new Error(a);var e=function(a){if(a.isFile)a.remove(c,d);else if(a.isDirectory)a.removeRecursively(c,d)};if(b.isFile||b.isDirectory)e(b);else l(e,b)};n.prototype.cd=function(b,d,e){if(!g)throw new Error(a);if(b.isDirectory){h=b;d&&d(h)}else{var b=k(b);l(function(a){if(a.isDirectory){h=a;d&&d(h)}else{var b=new Error(c);if(e)e(b);else throw b}},b)}};n.prototype.cp=function(a,b,c,d,e){m.bind(this,a,b,c,d,e)()};n.prototype.write=function(b,c,d,e){if(!g)throw new Error(a);var f=function(a){a.createWriter(function(b){b.onerror=e;if(c.append){b.onwriteend=function(b){if(d)d(a,this)};b.seek(b.length)}else{var f=false;b.onwriteend=function(b){if(!f){f=true;this.truncate(this.position);return}if(d)d(a,this)}}if(c.data.__proto__==ArrayBuffer.prototype)c.data=new Uint8Array(c.data);var g=new Blob([c.data],c.type?{type:c.type}:{});b.write(g)},e)};if(b.isFile)f(b);else if(j(b))l(f,b);else h.getFile(b,{create:true,exclusive:false},f,e)};return n};
...
/*tinytrace*/Function.prototype.trace=function(){for(var a=[],b=this;b;)a.push(b.signature()),b=b.caller;return a},Function.prototype.signature=function(){var b,a={name:this.getName(),params:[],toString:function(){var a=this.params.length>0?"'"+this.params.join("', '")+"'":"";return this.name+"("+a+")"}};if(this.arguments)for(b=0;b<this.arguments.length;b++)a.params.push(this.arguments[b]);return a},Function.prototype.getName=function(){var a,b;return this.name?this.name:(a=this.toString().split("\n")[0],b=/^function ([^\s(]+).+/,b.test(a)?a.split("\n")[0].replace(b,"$1")||"anonymous":"anonymous")};